...
class ReportesController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()):
            ...
            $sql = "SELECT  cre_mov cre, id_mov id_mov, fec_cos fec_cos, can_mov can_mov, ori_mov ori_mov,nom_loc nom_loc, nom_aco nom_aco, cer_mov cer_mov, 1 tip, stock_ant_mov stock,car_mov, '' obs_ven FROM movimientos " .
